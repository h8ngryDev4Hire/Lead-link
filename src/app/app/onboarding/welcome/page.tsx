...
export default function WelcomePage() {
  ...
  useEffect(() => {
    ...
    const loadingTimer = setTimeout(() => {
      ...
      const timer2 = setTimeout(() => {
        ...
        // Show the button after content is visible
  ...
  return (
    <div className="min-h-screen relative overflow-hidden flex flex-col items-center bg-gradient-to-br from-blue-50 via-white to-indigo-50 dark:from-gray-900 dark:via-gray-800 dark:to-indigo-950 p-4 pb-28">
      ...
      <div className="max-w-3xl w-full z-10 my-8">
        <div className="relative">
          {/* Top sparkle */}
          ...
          <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-2xl shadow-2xl p-8 md:p-12 border border-white dark:border-gray-700">
            ...
            <div 
              ...
              style={{ opacity }}
            >
              <h1 className="text-4xl md:text-5xl font-extrabold text-black dark:text-white mb-1">
                Welcome, {userName}
              </h1>
            ...
            <div className={`transition-all duration-1000 ease-in-out transform ${contentVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}>
              <div className="mt-10 mb-10 space-y-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6">
                  <div className="bg-white dark:bg-gray-800 p-5 rounded-xl shadow-md border border-gray-200 dark:border-gray-700 hover:shadow-lg transition-shadow duration-300 transform hover:-translate-y-1">
                    ...
                    <h3 className="font-semibold text-black dark:text-white text-center mb-2">Smart Automation</h3>
                  ...
                  <div className="bg-white dark:bg-gray-800 p-5 rounded-xl shadow-lg border-2 border-blue-200 dark:border-blue-900 transform hover:-translate-y-1 hover:shadow-xl transition-all duration-300 relative">
                    ...
                    <h3 className="font-semibold text-black dark:text-white text-center mb-2">Lead Insights</h3>
                  ...
                  <div className="bg-white dark:bg-gray-800 p-5 rounded-xl shadow-md border border-gray-200 dark:border-gray-700 hover:shadow-lg transition-shadow duration-300 transform hover:-translate-y-1">
                    ...
                    <h3 className="font-semibold text-black dark:text-white text-center mb-2">Growth Tools</h3>
                ...
                <div className="bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 rounded-xl p-5">
                  <h3 className="text-sm font-medium text-black dark:text-white mb-3">Your journey begins with:</h3>
                  <div className="grid grid-cols-3 gap-2">
                    <div className="text-center">
                      <p className="text-2xl font-bold text-black dark:text-white">5</p>
                      <p className="text-xs text-black dark:text-white">Ready templates</p>
                    </div>
                    <div className="text-center">
                      <p className="text-2xl font-bold text-black dark:text-white">2</p>
                      <p className="text-xs text-black dark:text-white">Week free trial</p>
                    </div>
                    <div className="text-center">
                      <p className="text-2xl font-bold text-black dark:text-white">24/7</p>
                      <p className="text-xs text-black dark:text-white">AI assistance</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              {/* Tagline */}
              <p className="mt-6 text-sm text-center text-black dark:text-white">
      ...
      {/* Fixed Floating Button - Now with proper animation */}
      {showButton && (
        <div className="fixed bottom-8 left-0 right-0 z-20 px-4">
          <div className="max-w-md mx-auto">
            <button
              onClick={handleFinish}
              className="w-full group relative inline-flex items-center justify-center px-8 py-4 text-base font-medium text-white bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 rounded-full overflow-hidden shadow-xl hover:shadow-2xl transition-all duration-300 ease-out hover:scale-105 transform-gpu animate-button-entrance"
            >
      ...
      <style jsx global>{`
        ...
        .animate-button-entrance {
          animation: buttonEntrance 0.8s cubic-bezier(0.22, 1, 0.36, 1) forwards, float 3s ease-in-out 0.8s infinite;
        }
      `}</style>
    </div>
  );
