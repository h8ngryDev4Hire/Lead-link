...
export default function ContactTasksPage({ params }: { params: { id: string } }) {
        ...
        <div className="max-w-2xl mx-auto">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg p-6 shadow-sm mb-6">
            <div className="flex flex-col items-center justify-center py-12">
              <ListTodo size={48} className="text-blue-600 dark:text-blue-400 mb-4" />
              <h2 className="text-xl font-semibold mb-2">Tasks Coming Soon</h2>
              <p className="text-gray-500 dark:text-gray-400 text-center max-w-md">
                This section will allow you to manage tasks and follow-ups related to this contact.
              </p>
            </div>
          </div>
        </div>
