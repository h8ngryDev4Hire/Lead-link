...
import { Search, Database, ChartBar, CheckCircle, Building, Sparkles, Zap, Bot, Loader2 } from 'lucide-react';
import { useRouter } from 'next/navigation';

// Animation steps that describe what the AI is doing
const searchSteps = [
  { message: "Searching the web for your business information...", icon: Search, color: "blue" },
  { message: "Analyzing social media profiles...", icon: ChartBar, color: "indigo" },
  { message: "Collecting business details...", icon: Database, color: "purple" },
  { message: "Building your business profile...", icon: Building, color: "teal" },
  { message: "Finalizing setup...", icon: CheckCircle, color: "green" }
];
...
export default function BuildingProfilePage() {
  ...
  useEffect(() => {
    ...
    }, 80); // Speed of progress animation
  ...
  return (
    <div className="min-h-screen relative flex flex-col justify-center items-center bg-gradient-to-br from-blue-50 via-white to-indigo-50 dark:from-gray-900 dark:via-gray-800 dark:to-indigo-950 p-4 overflow-hidden">
      ...
      <div className="w-full max-w-2xl z-10">
        ...
        {/* Main Card */}
        <div className="bg-white/90 dark:bg-gray-800/90 backdrop-blur-sm rounded-2xl shadow-2xl p-8 border border-white dark:border-gray-700 relative overflow-hidden">
          {/* Animation Container */}
          <div className="text-center mb-8 relative">
            ...
            <h1 className="text-3xl md:text-4xl font-extrabold mt-6 bg-clip-text text-transparent bg-gradient-to-r from-blue-600 to-indigo-600 dark:from-blue-400 dark:to-indigo-400">
          ...
          <div className="text-center mt-8">
            <div className={`inline-flex items-center ${isComplete ? 'text-green-600 dark:text-green-400' : 'text-gray-600 dark:text-gray-400'} text-sm transition-colors duration-300`}>
              {isComplete ? (
                <>
                  <CheckCircle size={18} className="mr-2" />
                  Profile creation complete! Proceeding to verification...
                </>
              ) : (
                <>
                  <Loader2 size={18} className="mr-2 animate-spin" />
                  Please wait while we set up your business profile...
                </>
              )}
            </div>
          </div>
