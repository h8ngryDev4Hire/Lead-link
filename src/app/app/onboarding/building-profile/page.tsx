    ...
    const timer = setInterval(() => {
      setProgress(prevProgress => {
        if (prevProgress >= 100) {
          ...
          setTimeout(() => {
            router.push('/app/onboarding/verify');
          }, 1500);
      ...
      <div className="w-full max-w-2xl z-10">
        ...
        <div className="bg-white/90 dark:bg-gray-800/90 backdrop-blur-sm rounded-2xl shadow-2xl p-8 border border-white dark:border-gray-700 relative overflow-hidden">
          ...
          <div className="text-center mt-8">
            <div className={`inline-flex items-center ${isComplete ? 'text-black dark:text-white' : 'text-black dark:text-white'} text-sm transition-colors duration-300`}>
              {isComplete ? (
                <>
