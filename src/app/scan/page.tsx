    ...
    <Layout title="Scan Lead">
      <div className="flex flex-col items-center justify-center h-full py-8 space-y-8">
        ...
        <div className="w-full max-w-xs grid grid-cols-1 gap-4 mt-8">
          <button className="flex items-center justify-center gap-2 bg-blue-600 hover:bg-blue-700 text-white font-medium py-3 px-4 rounded-lg">
            <Camera size={20} />
            Take Photo
          </button>
          
          <button className="flex items-center justify-center gap-2 border border-gray-300 dark:border-gray-700 hover:bg-gray-100 dark:hover:bg-gray-800 py-3 px-4 rounded-lg">
            <Upload size={20} />
            Upload Image
          </button>
